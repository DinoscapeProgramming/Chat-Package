function defaultFunction(socket, name) { 
  ["createRoom", "editRoom", "deleteRoom", "getRoom", "allRooms", "joinRoom", "leaveRoom", "sendMessage", "editMessage", "deleteMessage", "getMessage", "createUser", "editUser"].forEach((action) => {
